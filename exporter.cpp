...
void Exporter::exportCBMisc(float lrate,float errAbs,float ratio,float prevErrAbs,float upd_coef_real, float upd_coef_cb, float optimalLambda)
{
  foutCBMisc<<lrate<<'\t'   // 0
    <<errAbs<<'\t'          // 1
    <<ratio<<'\t'           // 2
